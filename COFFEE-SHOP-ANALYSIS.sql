-- This is to explore the dataset in full and see the different rows and columns that make up the 
dataset 
SELECT * 
FROM BRIGHTLEARN.COFFEESHOP.SALES; -- Here I want to see how many store locations there are 
SELECT DISTINCT STORE_LOCATION 
FROM BRIGHTLEARN.COFFEESHOP.SALES; -- To Check the different products which are offered  
SELECT DISTINCT PRODUCT_CATEGORY 
FROM BRIGHTLEARN.COFFEESHOP.SALES; -- To Check the different product typs which are offered  
SELECT DISTINCT PRODUCT_TYPE 
FROM BRIGHTLEARN.COFFEESHOP.SALES; -- In this code I would like to explore the amount of Transactions there are  
SELECT Count(DISTINCT TRANSACTION_ID) 
FROM BRIGHTLEARN.COFFEESHOP.SALES; -- To Check when the shop start operating 
SELECT MIN(TRANSACTION_DATE) AS Shop_Opening_Date 
FROM BRIGHTLEARN.COFFEESHOP.SALES; -- To Check whe the last time the shop performed a transction  
